export default [
    {
        ...
        characters: [
            ...
            { character: '½', latexCommand: window.RichTextEditor.useAsFroalaPlugin ? '\\text{½}' : '\\frac{1}{2}', popular: true },
            { character: '⅓', latexCommand: window.RichTextEditor.useAsFroalaPlugin ? '\\text{⅓}' : '\\frac{1}{3}', popular: true },
